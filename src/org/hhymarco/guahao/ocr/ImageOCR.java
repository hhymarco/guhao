package org.hhymarco.guahao.ocr;
...
public class ImageOCR {
    ...
    public static BufferedImage removeBackgroud(String picFile)
            throws Exception {
        BufferedImage img = ImageIO.read(new URL(picFile));
        return _removeBackgroud(img);
    }
    ...
    public static BufferedImage _removeBackgroud(BufferedImage img)
            throws Exception {
    ...
    public static String getAllOcr(InputStream is) throws Exception {
        BufferedImage img = removeBackgroud(is);
        java.util.List<BufferedImage> listImg = splitImage(img);
